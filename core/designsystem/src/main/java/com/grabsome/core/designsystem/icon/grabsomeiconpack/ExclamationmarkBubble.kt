...
val GrabsomeIcons.ExclamationmarkBubble: ImageVector
    get() {
        if (_exclamationmarkBubble != null) {
            return _exclamationmarkBubble!!
        }
        _exclamationmarkBubble = Builder(name = "ExclamationmarkBubble", defaultWidth = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.0f, 8.5f)
                curveTo(7.8517f, 8.5f, 7.7067f, 8.544f, 7.5833f, 8.6264f)
                curveTo(7.46f, 8.7088f, 7.3639f, 8.8259f, 7.3071f, 8.963f)
                curveTo(7.2503f, 9.1f, 7.2355f, 9.2508f, 7.2644f, 9.3963f)
                curveTo(7.2934f, 9.5418f, 7.3648f, 9.6754f, 7.4697f, 9.7803f)
                curveTo(7.5746f, 9.8852f, 7.7082f, 9.9566f, 7.8537f, 9.9856f)
                curveTo(7.9992f, 10.0145f, 8.15f, 9.9997f, 8.287f, 9.9429f)
                curveTo(8.4241f, 9.8861f, 8.5412f, 9.79f, 8.6236f, 9.6667f)
                curveTo(8.706f, 9.5433f, 8.75f, 9.3983f, 8.75f, 9.25f)
                curveTo(8.75f, 9.0511f, 8.671f, 8.8603f, 8.5303f, 8.7197f)
                curveTo(8.3897f, 8.579f, 8.1989f, 8.5f, 8.0f, 8.5f)
                close()
            }
        }
        .build()
...
private var _exclamationmarkBubble: ImageVector? = null
