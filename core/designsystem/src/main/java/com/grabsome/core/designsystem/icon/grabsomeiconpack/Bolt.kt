...
val GrabsomeIcons.Bolt: ImageVector
    get() {
        if (_bolt != null) {
            return _bolt!!
        }
        _bolt = Builder(name = "Bolt", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(8.8748f, 6.5f)
                lineTo(9.8748f, 2.0f)
                horizontalLineTo(5.8998f)
                lineTo(4.6298f, 7.5f)
                horizontalLineTo(7.5848f)
                lineTo(6.7898f, 12.64f)
                lineTo(11.4998f, 6.5f)
                horizontalLineTo(8.8748f)
                close()
            }
        }
        .build()
